...
4. For community build context, prefer local Overframe cache; if missing, crawl only when Online is opted in (see recommend-build source policy / community-search skill).
