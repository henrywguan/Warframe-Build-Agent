...
4. For community build context, prefer local Overframe cache; if missing, crawl immediately (Hermes always online — see recommend-build source policy / community-search).
