...
4. For community build context, prefer local Overframe cache; if missing, ask yes/no before online Overframe/YouTube search (see recommend-build source policy).
