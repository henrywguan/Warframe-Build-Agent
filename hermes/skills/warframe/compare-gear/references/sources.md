...
1. **Repo docs / source policy** — how to interpret live data and when to ask before online build search.
...
6. **Overframe** — community builds: https://overframe.gg/ — prefer local cache; ask before online search when missing.
7. **YouTube creator builds** — only when cited or after online-search consent; never invent fake URLs.
