...
- Hermes: profile v0.5.0 (always online + coding agent) + [`hermes/LOCAL_LLM.md`](../hermes/LOCAL_LLM.md) / [`hermes/CODING.md`](../hermes/CODING.md); pack with `./scripts/pack-hermes-profile.sh`
