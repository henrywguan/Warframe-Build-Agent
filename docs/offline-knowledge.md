...
- Hermes: profile v0.6.0 (Cursor-class agent + always online + Warframe) + [`hermes/LOCAL_LLM.md`](../hermes/LOCAL_LLM.md) / [`hermes/CODING.md`](../hermes/CODING.md); pack with `./scripts/pack-hermes-profile.sh`
