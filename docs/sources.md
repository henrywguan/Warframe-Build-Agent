...
5. **Warframe Market** — trade prices and availability: https://warframe.market/ (volatile; always caveat).
...
| Price mismatch | Market moves fast | Give a range/order-of-magnitude, not a hard quote |
