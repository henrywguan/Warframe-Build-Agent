...
Hermes Desktop import ships the matching player-facing skills (v0.4.2, always online) under `hermes/skills/warframe/` (+ `skills/research/agent-reach`) — see [`docs/hermes-export.md`](hermes-export.md) and [`hermes/LOCAL_LLM.md`](../hermes/LOCAL_LLM.md) for Qwen/Ollama.
